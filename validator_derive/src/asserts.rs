...
pub static NUMBER_TYPES: [&str; 71] = [
    "usize",
    "u8",
    "u16",
    "u32",
    ...
    "Option<Option<NonZeroU128>>",
    "Option<Option<NonZeroIsize>>",
    "Option<Option<NonZeroI8>>",
    "Option<Option<NonZeroI16>>",
    "Option<Option<NonZeroI32>>",
    "Option<Option<NonZeroI64>>",
    "Option<Option<NonZeroI128>>",
];
